...
public interface IGraf<K extends Comparable<K>, V>  {

    ////////////////////////////////////////////////////////////////////////////////////
    // Operacions per a treballar amb els vertexs

    // Es calcula la modularitat de la partició escollida del graf.
    // public float modularitat();
    ...
    // // Metode per saber si un vertex del graf es trba inserit.
